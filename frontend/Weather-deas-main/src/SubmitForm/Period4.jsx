...
function Period4({ formData, setFormData }) {
  ...
  const handleZeroChange = (e) => {
    setFormData({ ...formData, PercipZeroToTraceP4: e.target.value });
  };
  const handleTraceChange = (e) => {
    setFormData({ ...formData, PercipZeroToTraceP4: e.target.value });
  };
  const handleFourteenChange = (e) => {
    setFormData({ ...formData, Percip06To14P4: e.target.value });
  };
  const handleTwentyFourChange = (e) => {
    setFormData({ ...formData, Percip15To24P4: e.target.value });
  };
  const handleFortyNineChange = (e) => {
    setFormData({ ...formData, Percip25To49P4: e.target.value });
  };
  const handleFiftyChange = (e) => {
    setFormData({ ...formData, Percip50PlusP4: e.target.value });
  };
    ...
    <div className="period-1-container">
      <div className="entries-1">
        ...
        <select
          ...
          value={formData.PercipZeroToTraceP4}
        >
        ...
        <select
          ...
          value={formData.PercipTraceTo005P4}
        >
          <option value="0">0</option>
          <option value="1">1</option>
          <option value="2">2</option>
