...
import Period1 from './Period1.jsx';
import Period2 from './Period2.jsx';
import Period3 from './Period3.jsx';
import Period4 from './Period4.jsx';
...
function SubmitForm() {
  ...
  let createEntry = axios.post('/api/detailcreate/',
      {
